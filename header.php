	...
	<div id="page" class="hfeed site">
		...
		?>
			...
			<div class="intro--video">
				<video playsinline autoplay="" preload="none" controls="none" loop muted id="intro__video" poster="<?php echo get_template_directory_uri(); ?>/inc/imgs/video-poster-04.jpg">
